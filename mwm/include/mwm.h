 ...
 *
 * mwm.h: global variables that are used all over mwm.
 *
 */
#pragma once
 ...
 * window manager is present. This window is created when mwm starts and
 * kept alive until mwm exits.
