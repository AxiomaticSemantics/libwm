...
typedef struct {
    ...
    bool stopped;
    /**
     * The signal requested by the client to inform it of the hidden state of mwm-bar
     */
    int stop_signal;
    /**
     * The signal requested by the client to inform it of the unhidden state of mwm-bar
     */
    int cont_signal;
